...
def test_basic_conversion(gooddata_tpcds_dict: dict):
...
def test_datasets_converted(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
...
def test_dataset_source(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_primary_key_from_grain(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_attributes_become_dimension_fields(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_facts_become_plain_fields(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_maql_expressions(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_references_become_relationships(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_date_instance_converted(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_labels_in_custom_extensions(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
    result = importer.to_osi(gooddata_tpcds_dict)
    sm = result["semantic_model"][0]
...
def test_data_source_id_extension(gooddata_tpcds_dict: dict):
    importer = GoodDataImporter()
